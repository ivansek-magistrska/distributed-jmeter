...
class AWS:
    ...
    def get_autoscalability_data(self, start_time, end_time):
        ...
        def filter_activites(activites):
            ...
            for activity in activites:
                ...
                a = {
                    ...
                    'start_time': activity.start_time + datetime.timedelta(hours=utc_offset/3600),
                    'end_time': activity.end_time + datetime.timedelta(hours=utc_offset/3600),
        ...
        activites = autoscale.get_all_activities('cloudscale-as')
        launching_ids = []
        terminating_ids = []
    ...
    def _progress(self, transferred, to_go):
        mb_transferred = transferred / 1024 / 1024
        mb_to_go = to_go / 1024 / 1024
        self.logger.log("%s MB of %s MB transferred" % (mb_transferred, mb_to_go))
    ...
    def get_cloudwatch_ec2_data(self, start_time, end_time, instance_ids):
        conn = boto.ec2.cloudwatch.connect_to_region(
            self.region,
            aws_access_key_id=self.showcase_aws_access_key,
            aws_secret_access_key=self.showcase_aws_secret_key
        )
        data = []
